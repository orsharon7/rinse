...
(function () {
  ...
  const CMD = 'rinse run --pr 42';
  const OUTPUT_LINES = [
    { text: '● iteration 1  waiting for Copilot…', cls: 'tline-dim',    delay: 700  },
    { text: '● iteration 1  fixing 3 comments',    cls: 'tline-yellow', delay: 1200 },
    { text: '  ↳ pushed fix — re-requesting review', cls: 'tline-dim',  delay: 500  },
    { text: '● iteration 2  waiting for Copilot…', cls: 'tline-dim',    delay: 1000 },
    { text: '✓ Approved · saved you 6 min · fixed 3 comments', cls: 'tline-green', delay: 1400 },
  ];
  ...
  function tick () {
    ...
    if (phase === 'output') {
      if (lineIdx < OUTPUT_LINES.length) {
        ...
        const delay = line.delay !== undefined ? line.delay : 400;
        lineIdx++;
