...
var (
	// styleAppHeader — 1-line top bar; no explicit bg so it reads against the
	// terminal background, consistent with the rest of the Catppuccin palette.
	...
	// styleAppFooter — 1-line bottom bar.
