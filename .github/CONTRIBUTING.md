...
| `db` | `#0052CC` | Database / storage |
| `docs` | `#0075ca` | Documentation |
| `legal` | `#cfd3d7` | Legal |
| `brand` | `#8B5CF6` | Brand |
| `engine` | `#0075ca` | Review cycle engine / runner scripts |
| `tui` | `#1d76db` | TUI application |

### Priority labels

| Label | Color | Meaning |
|-------|-------|---------|
| `p0-critical` | `#b60205` | Blocker — nothing ships without this |
